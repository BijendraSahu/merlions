/**
 * Created by Pinku on 12/30/2017.
 */
/*
...
if (typeof Object.create !== "function") {
    ...
    var i = {
        ...
        buildNavigation: function() {
            ...
            if (t) {
                //var n = '<ul class="pagination pull-right" style="margin: 0px;">' + '<li><a href="#" class="prev"><span class="mdi mdi-chevron-down"></span></a></li>' + '<li><a href="#" class="next"><span class="mdi mdi-chevron-up"></span></a></li>' + '</ul><div class="clearfix"></div>';
                var n='<div class="btn_earnertopblock"><span class="btnblock prev"><i class="mdi mdi-chevron-down"></i></span><span class="btnblock next"><i class="mdi mdi-chevron-up"></i></span></div>';
                var r = e(t).find("#earner_clkbtn")[0];
                var ad = e(t).find("#adver_clkbtn")[0];
                if (r) {
                    e(r).append(n)
                } else {
