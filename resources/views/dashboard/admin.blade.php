...
@section('content')
    ...
    ">Welcome to Merlions Travels</h2>
        <hr/>
            ...
            <table width="100%" border="0" align="left">
                ...
                <tr>
                    ...
                    <td width="19%" align="center"><a href="{{url('hotel')}}" class="a_txt"><i
                            ...
                            <h4>Hotels</h4></a></td>
                    <td width="19%" align="center"><a href="{{url('air')}}" class="a_txt"><i
                                    class="fa awesome_style animated-hover faa-tada faa-fast fa-reply-all"></i> <br>
                            <h4>Airport Transfer</h4></a></td>
                    {{--<td width="19%" align="center"><a href="{{url('transfer')}}" class="a_txt"><i--}}
                                    {{--class="fa awesome_style animated-hover faa-tada faa-fast fa-location-arrow"></i><br>--}}
                            {{--<h4>Tour Transfer</h4></a></td>--}}
                    <td width="19%" align="center"><a href="{{url('ttcharges')}}" class="a_txt"><i
                                    class="fa awesome_style animated-hover faa-tada faa-fast fa-bus"></i><br>
                            <h4>Tour Transfer Charges</h4></a></td>
                    <td align="center"><a href="{{url('extra_transfer')}}" class="a_txt"><i
                                    class="fa awesome_style animated-hover faa-tada faa-fast fa-i-cursor"></i><br>
                            <h4>Extra Transfer</h4></a></td>
                    <td align="center"><a href="{{url('meal')}}" class="a_txt"><i
